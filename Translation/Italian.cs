...
namespace Operations.Search
{
    ...
    #endregion
    /// <summary>
    /// Implements an Operation which translates the text into Italian
    /// </summary>
    [OperationDescription("Translates the document to Italian", MenuName="Translate")]
    public class ItalianTranslationOperation: TranslationOperation
    {
        #region Constants
        #endregion
        ...
        public override string Execute(string sourceText, IWin32Window ownerWindow)
        {
            ...
            string translated = client.Translate(sourceText, LastLanguageUsed, Language.Italian);
            LastLanguageUsed = Language.Italian;
