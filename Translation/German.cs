...
namespace Operations.Search
{
    ...
    #endregion
    /// <summary>
    /// Implements an Operation which translates the text into German
    /// </summary>
    [OperationDescription("Translates the document to German", MenuName="Translate")]
    public class GermanTranslationOperation: TranslationOperation
    {
        #region Constants
        #endregion
        ...
        public override string Execute(string sourceText, IWin32Window ownerWindow)
        {
            ...
            string translated = client.Translate(sourceText, LastLanguageUsed, Language.German);
            LastLanguageUsed = Language.German;
