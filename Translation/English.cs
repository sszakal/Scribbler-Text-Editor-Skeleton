...
namespace Operations.Search
{
    ...
    #endregion
    /// <summary>
    /// Implements an Operation which translates the text into English
    /// </summary>
    [OperationDescription("Translates the document to English", MenuName="Translate")]
    public class EnglishTranslationOperation: TranslationOperation
    {
        #region Constants
        #endregion
        ...
        public override string Execute(string sourceText, IWin32Window ownerWindow)
        {
            ...
            string translated = client.Translate(sourceText, LastLanguageUsed, Language.English);
            LastLanguageUsed = Language.English;
