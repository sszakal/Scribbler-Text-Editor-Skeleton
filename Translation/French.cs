...
namespace Operations.Search
{
    ...
    #endregion
    /// <summary>
    /// Implements an Operation which translates the text into French
    /// </summary>
    [OperationDescription("Translates the document to French", MenuName="Translate")]
    public class FrenchTranslationOperation: TranslationOperation
    {
        #region Constants
        #endregion
        ...
        public override string Execute(string sourceText, IWin32Window ownerWindow)
        {
            ...
            string translated = client.Translate(sourceText, LastLanguageUsed, Language.French);
            LastLanguageUsed = Language.French;
