...
namespace Operations.Statistics
{
    ...
    /// </summary>
    [OperationDescription("Counts the number of characters, including whitespace, in the document", MenuName="Proofing Tools")]
    public class CharacterCountOperation: OperationBase
    {
        #region Constants
        #endregion
        ...
        {
            StatsDialog dlg = new StatsDialog(sourceText.Length);
            dlg.ShowCharacterCount = true;
